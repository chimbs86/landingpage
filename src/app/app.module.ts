...
@NgModule({
  declarations: [
    AppComponent, WorkExperience, Education, Portfolio, About, Contact, Profile, NGXChartsComponent, AboutblockComponent, SentEmail
  ],
  imports: [
    BrowserModule,
    ReactiveFormsModule,
    HttpClientModule, NgxChartsModule, BrowserAnimationsModule, AppRoutingModule
  ],
  providers: [],
